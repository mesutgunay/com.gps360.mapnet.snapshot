...
#import "CDVmapNETSnapshot.h"
#import "MainViewController.h"

//NSString *const MAPNET_ERROR_DOMAIN = @"MAPNET_SNAPSHOT_ERROR_DOMAIN";
NSInteger const MAPNET_CAMERA_VIEW_TAGx = 999;
...
@implementation CDVmapNETSnapshot
{
...
{
    UIImageView* cameraView = (UIImageView *)[self.viewController.view viewWithTag: MAPNET_CAMERA_VIEW_TAGx];
    return cameraView;
}
...
-(CDVPlugin*)getVideoOverlayPlugin
{
    ...
    CDVPlugin* videoOverlayPlugin = [ctrl.pluginObjects objectForKey:@"CDVmapNETVideoOverlay"];
...
{
    MAPNET_IMAGE_ENCODING encodingType = [[command argumentAtIndex:0 withDefault:@(MAPNET_IMAGE_ENCODING_JPG)] unsignedIntegerValue];
    ...
    if (encodingType == MAPNET_IMAGE_ENCODING_JPG) {
...
- (void) saveToPhotoGallery:(CDVInvokedUrlCommand*)command {
    ...
    MAPNET_IMAGE_ENCODING encodingType = [[command argumentAtIndex:1 withDefault:@(MAPNET_IMAGE_ENCODING_JPG)]  unsignedIntegerValue];
...
typedef NS_ENUM(NSUInteger, MAPNET_ERROR_CODE) {
    MAPNET_ERROR_CODE_ERROR=1,
    MAPNET_ERROR_CODE_INVALID_ARGUMENT,
    MAPNET_ERROR_CODE_INVALID_STATE,
    MAPNET_ERROR_CODE_ACTIVATION
};

//
//
//
- (NSDictionary*)makeErrorResult: (MAPNET_ERROR_CODE) errorCode withData: (NSString*) description
{
...
//
//
- (NSDictionary*)makeErrorResult: (MAPNET_ERROR_CODE) errorCode withError: (NSError*) error
{
